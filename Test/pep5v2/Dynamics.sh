date
echo "La dinamica de pep5v2_ionized se podra ver en el puerto 3000"
echo "VMD: vmd `pwd`/pep5v2_ionized.psf `pwd`/pep5v2_ionized.pdb"
...
#Mover el psf
mv pep5v2_ionized.psf Fin/
echo "La dinamica de pep5v2_ionized ha concluido"
date
